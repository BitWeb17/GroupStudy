...
public class ThymeLeafTestController {
    ...
    public String registerForm004(Model model) {
        ...
        hobbyMap.put("02", "Prograing");
        hobbyMap.put("03", "Music");
        hobbyMap.put("04", "Move");
    ...
    @GetMapping("/registerJoinMemForm")
    public String registerJoinMemForm(Model model) {
        log.info("registerJoinMemForm()");

        model.addAttribute("testMember", new TestMember());

        return "spring/thyme/joinMemShipForm";
    }
}