...
public class RockPaperScissors {
    ...
    RockPaperScissors() {
        ...
        System.out.printf("연습 대련 입니다.\n");
    }

    RockPaperScissors(boolean duel) {
        scan = new Scanner(System.in);
        if (duel != true) {
            System.out.println("결투 모드 입니다. 다음부턴 true 설정을 해주세요 !");
        }
        this.duel = true;

        System.out.printf("결투 모드 입니다.\n");
    }
    ...
    public void playGame() {
        ...
        do {
            ...
            System.out.print("가위는 1, 바위는 2, 보자기는 3, 원하는 값을 입력하세요. ");
            ...
            // 가독성이 안 좋은 코드 : 문서를 작성해야 함 (동작에 대해)
