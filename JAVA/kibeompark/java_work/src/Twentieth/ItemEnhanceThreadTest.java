...
public class ItemEnhanceThreadTest {
    ...
    // SL에 값이 1 이냐 ? 아니냐 ?
    // 1 이면 현재 Lock 상태니까 들어오지마 !
    // 0 이면 현재 Unlock 상태니까 먼저 들어오는 놈이 임자 !
    ...
    // Thread 여러 개가 동시다발적으로 구동이 불가능한 반면
    // Semaphore는 Mutex List 같은 개념으로
    // Thread 여러 개가 동시다발적으로 구동이 가능하다.
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            // 문제는 이런 변수를 저장하게 되면
            // 자바의 GC(Garbage Collector)가 이것을 함께 관리해야 한다.
