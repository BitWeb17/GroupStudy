    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                // 결국 clntSock은 클라이언트 소켓을 의미하게 된다.
                // (전화 왔을 때 통화하기 슬라이드가 accept()라 보면 됨)
