...
public class WarLoad extends Warrior implements SkillTree {
    ...
    public WarLoad(int atk, int def, int dex, int intel,
                   int hp, int mental, float anger, int intention) {
        super(atk, def, dex, intel, hp, mental, anger);
    ...
    public void skill1() {
        ...
        System.out.println("일정 확률로 상대를 즉사 시킵니다.");
    ...
    public void skill2() {
        ...
        System.out.println("고속으로 이동하며 지나간 자리에 있는 모든 타겟을 0.3초 스턴시킵니다.");
    }
}
