...
class Test {
    ...
    public Test(int a, String n, String m) { // 생성자
        age = a;
        name = n;
        major = m;
    }

    public void camouflageTest(int a, String n, String m) { // 일종의 setter
        age = a;
        name = n;
        major = m;
    }
...
public class FirstPrivate {
    public static void main(String[] args) {
        ...
        // private 으로 지정한 데이터는
        // 현재와 같이 클래스('중괄호 열고 닫기') 외부에서 접근할 수 없다.
        ...
        // 2) Encapsulation(캡슐화)
        //    데이터가 있다면 이 데이터를 가공하는 기능들(메소드)이 있다.
        //    데이터를 가공할 수 있는 public 메소드를 제공하도록 한다.
    }
}