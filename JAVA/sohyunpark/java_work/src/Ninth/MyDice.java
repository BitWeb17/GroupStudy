...
public class MyDice {
                ...
                if (cnt == 1 && octahedronDice % 2 == 0){
                    ...
                    switch (octahedronDice) {
                        ...
                        case 2:
                            ...
                            break;
                        // 4 : 지정한 사용자의 주사위 값을 0으로 만든다.
                        case 4:
                            System.out.println("0으로 만들 사람을 고르세요 : ");
    ...
    public void printSumOfOctahedronDice() {
        for(int i = 0; i < playerNum; i++){
            System.out.printf("%d 번째 사용자 주사위 눈금합 = %d\n",
                    i, sumOfDice[i]);
        }
    }
    ...
    public void printSumOfDice(){
        for (int i = 0; i < playerNum; i++){
            ...
            // 정렬된 상태인 sumOfDice를 그대로 뿌려야 정렬값을 볼 수 있음
            System.out.printf("%d번째 사용자의 눈금 합 = %d\n" , playerArr[i], sumOfDice[i]);
        }
    }
