...
class X extends Thread {
    public void run() {
        for(int i = 0; i < 1000000; i++) {
            ...
            // 부분적으로 안전하게 보호한 반면
            // 이전의 예제는 메서드 전체를 보호했다.
            // 그러므로 당연히 Critical Section만 방해할 때에 비해 성능이 저하된다.
        ...
        System.out.println("plusMoney() : " + PerfSyncBankTest.psb.getMoney());
    }
}
...
class Y extends Thread {
    public void run() {
        ...
        System.out.println("minusMoney() : " + PerfSyncBankTest.psb.getMoney());
    }
}
