...
public class FirstArrayTest {
    public static void main(String[] args) {
        // 배열을 왜 사용하는가 ?
        // 계좌 금액
        // 4000만개의 int형 변수를 만들 것인가 ?
        // 4000만개를 직접 입력하기가 너무 빡세다.
        // 그러니까 배열을 사용해서 손쉽게 4000만개를 할당하는 것이다.

        // 아래 예의 경우 만약 배열이 없었다면
        // int arr1, arr2, arr3, arr4, arr5, arr6, arr7, arr8, arr9, arr10;
        ...
        //    * 변칙수 :
        //      중괄호를 열고 닫은 이후 아래와 같이 미리 값을 할당할 수도 있다.
        //      {1, 2, 4, 5, 2342, 25335, 30}

        // int 형 다발을 이름 arr 로 만들겠다.
        // int 형 공간을 10 개 만들겠다.
        // 위의 두 문장이 결합되어 int 형 배열 arr 는 int 형 공간 10 개를 가진다.
        int[] arr = new int[10];
