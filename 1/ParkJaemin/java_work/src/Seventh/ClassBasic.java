...
// 2) 중괄호 내부에는 클래스가 가져야할 속성을 변수를 만든다.
//    ex) 현재 케이스에서는 사람이므로 이름과 나이가 예로 해당한다.
...
class Person {
    ...
    public void setName(String name) {
        // 이름이 같은 경우 혼동을 방지하력기 위해 this를 사용한다.
        this.name = name;
    }
    ...
    // return 옆에 오는 클래스 내부부 변수의 데이터 타입 같아야 한다.
