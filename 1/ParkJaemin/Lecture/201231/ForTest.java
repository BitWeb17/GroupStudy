public class ForTest {
    public static void main(String[] args) {
        ...
        //    (초기화 ; 조건 ; 증감부) 형식으로 구성된다. // 구분자는 ;
        //     초기화 부분이 없을 수도 있으며
        //      조건이 없을 수도 있고
        //      증감부가 없을 수도 있다.
        //      모든 것이 없다면 무한루프가 될 수 있다.
        // 3. 중괄호 내부에는 while과 마찬가지로 반복시킬 내용을 작성한다.

        // for 문을 보는 방법
        // for(i=0; i < 3; i++) 의 의미는 무엇인가?
        // for(;;) ㅡ> 초기화, 조건, 증감부 없을 때는 구분자는 필수로 적어야 한다.
        // i=0 : 초기화 부분
        // 초기화 부분은 for문 진입시 최초로 한 번만 수행 된다.
        ...
        // 동작 과정
        // 초기화 : 최초로 한 번만
        // 조건 : 조건이 만족되는 동안만 반복 ㅡ> 조건이 만족되면 중괄호로 이동
        // 증감부 : 값을 증가하거나 감소시킴 ㅡ> 증감 이후에 조건을 확인함
        // 거짓이 되는 순간 for문을 빠져나가고 다음 for문으로 진출
        for(i=0; i < 3; i++){
        ...
        for(int j = 0; j < 4; j++) {
            ...
            // 더 이상 main 내에서 j가 살아 있는 변수가 아니기 떄문이다.
