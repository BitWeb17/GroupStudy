...
//    ex) 현재 케이스에서는 사람으로 이름과 나이가 예에 해당한다.
// 3) 해당 속성들을 제어할 수 있는 매서드로 구성된다.
class Person {
    String name;  //  person 클래스가 가지고 있는 네임
    int age;
    ...
    //    만약 이 부분에 void 가 적혀 있으면 넘겨줄 데이터가 없음을 의마한다.
    // 3) 매서드 이름을 작성한다.
    //    마음대로 작명을 해도 되지만
    ...
    //  return 옆에 오는 클래스 변수의 데이터타입이 같아야 한다.
...
public class ClassBasic {
    public static void main(String[] args) {
        ...
        // 매서드를 사용하는 이유는 무엇일까?
        // 1) 편리성 - 재활용:
        // 2) 전제조건 - 매서드를 잘 설계하고 유지보수가 쉽도록 만들었을 경우
