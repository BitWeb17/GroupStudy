...
public class MySeries {
    ...
    // 매서드 오버로딩이 일어나면서 양쪽을 모두 사용할 수 있게 된다.
    // 입력 개수가 다르기 때문에 자바 컴파일러가 알아서 구별해준다.
    private void printValue(int start, int end, int orderNum) {
        int cnt = 1;
    ...
    public void testPrintValue(int start, int end, int orderNum) {
        int cnt = 1;
    ...
    private void printValue(int start, int end) {
        int cnt = 1;
    ...
    public void testPrintValue(int start , int end){
        int cnt = 1;
