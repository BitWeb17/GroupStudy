...
import static JAVA_2021_01_14_Twelveth.Utility.MYSTRCMP;
import static JAVA_2021_01_14_Twelveth.Utility.STRCMPTEST;

// 실질적으로 interface에 작성한 프로토타이핑한 매서드는
...
public class MyStrcmp implements Comparable {
    ...
    // Object ??
    // Object는 모든 정보를 아우르고 있는 가장 거대한 집합이다.
    // 여기서 모든 정보란? 우리가 사용하는 모든 크래스 등등을 의미한다.
    // 그러므로 타입 캐스팅(형 변환)을 통해
    // 어떤 데이터든 Object형태로 받을 수 있다.
    // 만약 내용을 들은 사람이 C개발자라면 void * 생각하면 됩니다.
