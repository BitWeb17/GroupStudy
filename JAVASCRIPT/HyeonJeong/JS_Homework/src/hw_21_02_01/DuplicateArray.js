...
// 도대체 왜??? 이거하느라 다른거 시간을 다 써버렸다;;
// 랜더링?이 두번되는 것 같아서 디버깅 콘솔로그도 출력해봤지만 
// 콘솔에는 한번씩만 실행한 것으로 나온다! 아무리 봐도 2번 실행한 것 같은데
// 아무리 검색을 해봐도 모르겠다;;  현재시간 04:03..
// 일단 4시간 정도는 자야할 것 같아서 여기서 stop ㅠㅅㅠ 