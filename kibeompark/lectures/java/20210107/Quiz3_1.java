...
class Triangle {
    ...
    // return 타입이 void 이므로 반환 값은 없음
    // 입력은 외부에서 들어오는 base 라는 값
    public void setBase(float base) {
        // 클래스 내부의 base 에 외부에서 들어오는 base 를 대입해서 지정
        this.base = base;
    }
...
public class Quiz3_1 {
    public static void main(String[] args) {
        // 3) 클래스를 활용하여 삼각형의 넓이를 구하는 프로그램을 만들어 보자 !
        //  3-1) 밑변 * 높이 * 0.5
        //  3-2) 1/2 ab sin x
        //  3-3) 외적
...
class triangle {
    ...
    public void setArea() {
        ...
        height = scan.nextInt();
        System.out.print("두 변 사이 각을 입력하세요. ");
        angle = scan.nextInt();

        area1 = base * height / 2;
        area2 = base * height * Math.sin(angle) / 2;
    }
...
public class Quiz3 {
    public static void main(String[] args) {
        ...
        t.setArea();
        System.out.println("삼각형의 넓이 1 = " + t.getArea1());
        System.out.println("삼각형의 넓이 2 = " + t.getArea2());
    }
}
 */