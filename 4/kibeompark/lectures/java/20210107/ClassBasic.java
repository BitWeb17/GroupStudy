...
class Person {
    ...
    // void 면 return 이 없다.
    // 그러나 return 이 있다면 넘겨주는 데이터 타입과
    // return 옆에 오는 클래스 내부 변수의 데이터 타입이 같아야 한다.
...
public class ClassBasic {
    public static void main(String[] args) {
        ...
        // 메서드를 사용하는 이유는 무엇일까 ?
        // 1) 편리성 - 재활용 :
        //    전제조건 - 메서드를 잘 설계하고 유지보수가 쉽도록 만들었을 경우
        p.setName("아무개");
        p.setAge(12);
